...
class SelectMovieTicketPage extends StatefulWidget {
  const SelectMovieTicketPage({super.key});
...
class _SelectMovieTicketPageState extends State<SelectMovieTicketPage> {
  @override
