...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(name) => "${name} subtitles";

  static String m2(names) => "※ Original audio with ${names} subtitles";

  static String m3(count) => "${count} showtimes";

  static String m4(cinemaCount, showTimeCount) =>
      "${cinemaCount} cinemas · ${showTimeCount} showtimes";

  static String m5(n) => "${n} theaters with stock";

  static String m6(km) => "${km} km";

  static String m7(n) => "${n} users reported sold out";

  static String m8(time) => "Next: ${time}";

  static String m9(n) => "Quota ${n}";

  static String m10(n) => "${n} upcoming screening(s)";

  static String m11(seatCount) => "${seatCount} seats";

  static String m12(count) => "Found ${count} related cinemas";

  static String m13(count) => "Confirm selection of ${count} seats";

  static String m14(count) => "Selected ${count} seats";

  static String m15(reply) => "Reply to ${reply}";

  static String m16(total) => "Total ${total} replies";

  static String m17(count) => "${count} seats";

  static String m18(reply) => "Reply to ${reply}";

  static String m19(language) => "Translate to ${language}";

  static String m20(hours, minutes) => "${hours}h ${minutes}m";

  static String m21(total) => "Total ${total} replies";
  ...
  static String m24(minutes, seconds) =>
      "${minutes} minutes ${seconds} seconds until showtime";

  static String m25(seconds) => "${seconds} seconds until showtime";

  static String m26(ticketCount) => "${ticketCount} Movie Tickets";

  static String m27(date) => "Exp: ${date}";

  static String m28(count) => "${count} images";

  static String m29(maxSeat) => "A maximum of ${maxSeat} seats can be selected";

  static String m30(movieName) => "Share movie ticket: ${movieName}";

  static String m31(days) => "${days} days left";

  static String m32(hours) => "${hours} hours left";

  static String m33(minutes) => "${minutes} minutes left";

  static String m34(version) => "What\'s new in v${version}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "about_components_showTimeList_seatStatus_preSale":
            MessageLookupByLibrary.simpleMessage("Pre-sale"),
        "about_components_showTimeList_seatStatus_saleEnded":
            MessageLookupByLibrary.simpleMessage("Sale ended"),
        ...
        "about_components_showTimeList_subtitleChipShort":
            MessageLookupByLibrary.simpleMessage("Sub"),
        ...
        "benefit_feedback_please_select_phase":
            MessageLookupByLibrary.simpleMessage("Please select a phase first"),
        "benefit_feedback_select_cinema":
            MessageLookupByLibrary.simpleMessage("Select cinema"),
        "benefit_feedback_select_phase":
            MessageLookupByLibrary.simpleMessage("Select phase"),
        ...
        "benefit_hasBenefitsLabel":
            MessageLookupByLibrary.simpleMessage("Entrance benefits"),
        "benefit_hasBenefitsLabel_reRelease":
            MessageLookupByLibrary.simpleMessage("Re-release benefits"),
        "benefit_items": MessageLookupByLibrary.simpleMessage("Items"),
        "benefit_limit": MessageLookupByLibrary.simpleMessage("Limit"),
        "benefit_limit_cinema":
            MessageLookupByLibrary.simpleMessage("Specific cinemas only"),
        ...
        "benefit_status_soldOut":
            MessageLookupByLibrary.simpleMessage("Sold out"),
        "benefit_status_sufficient":
            MessageLookupByLibrary.simpleMessage("Sufficient"),
        "benefit_status_unknown":
            MessageLookupByLibrary.simpleMessage("Unknown"),
        "benefit_status_veryFew":
            MessageLookupByLibrary.simpleMessage("Very few"),
        ...
        "creditCard_currentDefaultHint":
            MessageLookupByLibrary.simpleMessage("This is your default card"),
        ...
        "movieDetail_reReleaseHistory_title":
            MessageLookupByLibrary.simpleMessage("Re-release history"),
        "movieDetail_viewPresaleTicket":
            MessageLookupByLibrary.simpleMessage("Presale"),
        ...
        "movieTicketType_mubitikeCode":
            MessageLookupByLibrary.simpleMessage("Ticket code (10 digits)"),
        "movieTicketType_mubitikeCodeHint":
            MessageLookupByLibrary.simpleMessage("Enter 10-digit code"),
        ...
        "movieTicketType_mubitikePassword":
            MessageLookupByLibrary.simpleMessage("Password (4 digits)"),
        ...
        "movieTicketType_mubitikeTapToInput":
            MessageLookupByLibrary.simpleMessage("Tap to input"),
        ...
        "movieTicketType_mubitikeUseCount":
            MessageLookupByLibrary.simpleMessage("Number to use"),
        ...
        "movieTicketType_priceRuleTitle":
            MessageLookupByLibrary.simpleMessage("Price Calculation"),
        "movieTicketType_seatCountLabel":
            MessageLookupByLibrary.simpleMessage(" seats"),
        ...
        "movieTicketType_singleSeatPrice":
            MessageLookupByLibrary.simpleMessage("Price per seat"),
        ...
        "orderDetail_benefit_feedback_benefit_label":
            MessageLookupByLibrary.simpleMessage("Benefit"),
        "orderDetail_benefit_feedback_cinema_label":
            MessageLookupByLibrary.simpleMessage("Cinema"),
        "orderDetail_benefit_feedback_hint": MessageLookupByLibrary.simpleMessage(
        ...
        "presaleDetail_perUserLimit":
            MessageLookupByLibrary.simpleMessage("Per Person Limit"),
        "presaleDetail_pickupNotes":
            MessageLookupByLibrary.simpleMessage("Pickup Notes"),
        "presaleDetail_price": MessageLookupByLibrary.simpleMessage("Price"),
        "presaleDetail_salePeriod":
            MessageLookupByLibrary.simpleMessage("Sale Period"),
        ...
        "presaleDetail_title":
            MessageLookupByLibrary.simpleMessage("Presale Ticket"),
        "presaleDetail_usagePeriod":
            MessageLookupByLibrary.simpleMessage("Usage Period"),
        ...
        "seatSelection_hasLockedOrderTitle":
            MessageLookupByLibrary.simpleMessage("Unfinished Order"),
        ...
        "ticket_benefit_feedback_btn":
            MessageLookupByLibrary.simpleMessage("Feedback"),
        "ticket_benefit_feedback_lead": MessageLookupByLibrary.simpleMessage(
            "Help others by confirming benefit stock"),
        "ticket_benefit_feedback_select_ticket":
            MessageLookupByLibrary.simpleMessage("Select show to feedback"),
        "ticket_buyTickets":
            MessageLookupByLibrary.simpleMessage("Buy Tickets"),
        "ticket_endTime":
        ...
        "user_creditCard": MessageLookupByLibrary.simpleMessage("Manage Cards"),
        "user_currentVersion":
            MessageLookupByLibrary.simpleMessage("Current Version"),
        ...
        "user_timeFormat_24h": MessageLookupByLibrary.simpleMessage("24-hour"),
        "user_timeFormat_30h": MessageLookupByLibrary.simpleMessage("30-hour"),
