...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m17(count) => "共${count}张";

  static String m18(maxSeat) => "最大选座数量不能超过${maxSeat}个";

  static String m19(movieName) => "分享电影票: ${movieName}";

  static String m20(days) => "还有${days}天";

  static String m21(hours) => "还有${hours}小时";

  static String m22(minutes) => "还有${minutes}分钟";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "movieDetail_hasBonus": MessageLookupByLibrary.simpleMessage("含特典"),
        "movieDetail_presaleHasBonus":
            MessageLookupByLibrary.simpleMessage("预售券含特典"),
        "movieDetail_viewPresaleTicket":
            MessageLookupByLibrary.simpleMessage("查看预售券"),
        ...
        "presaleDetail_applyMovie":
            MessageLookupByLibrary.simpleMessage("适用影片"),
        ...
        "presaleDetail_buy": MessageLookupByLibrary.simpleMessage("购买"),
        "presaleDetail_buyNow": MessageLookupByLibrary.simpleMessage("立即购买"),
        "presaleDetail_delivery": MessageLookupByLibrary.simpleMessage("配送方式"),
        "presaleDetail_description":
            MessageLookupByLibrary.simpleMessage("详情说明"),
        "presaleDetail_finalPrice": MessageLookupByLibrary.simpleMessage("到手价"),
        ...
        "presaleDetail_salePeriod":
            MessageLookupByLibrary.simpleMessage("发售时间"),
        "presaleDetail_salePeriodNote":
            MessageLookupByLibrary.simpleMessage("本商品为预售券，销售期间如下："),
        "presaleDetail_specs": MessageLookupByLibrary.simpleMessage("规格与价格"),
        "presaleDetail_stock": MessageLookupByLibrary.simpleMessage("库存"),
        "presaleDetail_title": MessageLookupByLibrary.simpleMessage("预售券详情"),
        "presaleDetail_usagePeriod":
            MessageLookupByLibrary.simpleMessage("使用时间"),
        ...
        "seatSelection_hasLockedOrderMessage":
            MessageLookupByLibrary.simpleMessage("您有未支付的订单，请先完成支付"),
        "seatSelection_hasLockedOrderTitle":
            MessageLookupByLibrary.simpleMessage("未支付订单"),
